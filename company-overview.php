...
<body class="standard-view" style="background: var(--white);">
    ...
    <div class="col-md-12">
        <div class="container-fluid p-0">
            ...
            <section class="col-12">
                <div class="">
                    <div class="row m-0">
                        ...
                        <div class="align-items-center col d-flex side1">
                        ...
                        <div class="col-1 d-none d-sm-block"></div>
                        <div class="col-4 side2 d-none d-sm-block overflow-hidden">
            ...
            <!--Cosmo Today start-->
            <div class="cosmoTodayBanner" style="background-image: url(img/cosmo-today.jpg); border-top: 7px solid red;">
                    <div class="container">
            ...
            <!-- R&D Start -->
            <div  class="cosmoTodayBanner" style="background-image: url(img/rnd.jpg);">
                    <div class="container">
