        ...
        <div class="container-fluid p-0">
            <!-- banner  -->
                <div class="generalBanner" style="background-image: url(img/redblack.jpg); background-size: cover;">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p>Home  / Products /  Global Range / Flexible Packaging Films</p>
                                <h2>FLEXIBLE PACKAGING <br> FILMS</h2>
                                <div class="mt-5 pt-5"></div>
                                <div class="mt-4 pt-4"></div>
                            </div>
                        </div>
                    ...
                    <img class="d-none d-lg-block fpfBannerImg" src="img/packing-films.png" alt="">
                </div>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="bg-white p-4">
                            ...
                            <ul class="text-primary">
                                <li class="mb-2">Transparent Printing & Pouching Films</li>
                                <li class="mb-2">Matte Printing & Pouching Films</li>
                                <li class="mb-2">Pigmented White/Pearlized Printing & Pouching films</li>
                                <li class="mb-2">Metalized Printing & Pouching Films</li>
                                <li>CPP Films</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container-flued bg-white mt-5" style="border-top: 7px solid red;">
